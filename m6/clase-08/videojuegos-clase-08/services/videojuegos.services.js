...
// PUT Videojuego / Service
export const actualizarVideojuegoPorID = (id, datosActualizados) => {
  const videojuegos = obtenerVideoJuegos();

  const index = videojuegos.findIndex((juego) => juego.id === id);
  ...
  videojuegos[index] = videojuegoActualizado;
